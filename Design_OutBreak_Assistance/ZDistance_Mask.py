...
while True:
    ...
    for (box, pred) in zip(locs, preds):
        ...
        if label == "Mask":
            ...
            # playsound('sound/fastbeepM.mp3')
            playsound('C:\Program Files\Innovation projects\CovidEnforcement\MaskCheck\Disease_OutBreak_Assistance\sound\mask_sound_long.mp3')
    ...
    for (i, (prob, bbox, centroid)) in enumerate(results):
        ...
        if i in serious:
            ...
            playsound(r"C:\Program Files\Innovation projects\CovidEnforcement\MaskCheck\Disease_OutBreak_Assistance\sound\testsound.mp3")
